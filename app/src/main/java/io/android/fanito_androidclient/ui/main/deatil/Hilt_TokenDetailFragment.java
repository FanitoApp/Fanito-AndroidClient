...
public abstract class Hilt_TokenDetailFragment<T extends ViewDataBinding, V extends BaseViewModel<?>> extends BaseFragment<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TokenDetailFragment_GeneratedInjector) this.generatedComponent()).injectTokenDetailFragment(UnsafeCasts.<TokenDetailFragment>unsafeCast(this));
    }
  }
