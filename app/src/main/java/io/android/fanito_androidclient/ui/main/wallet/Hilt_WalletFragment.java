...
public abstract class Hilt_WalletFragment<T extends ViewDataBinding, V extends BaseViewModel<?>> extends BaseFragment<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WalletFragment_GeneratedInjector) this.generatedComponent()).injectWalletFragment(UnsafeCasts.<WalletFragment>unsafeCast(this));
    }
  }
