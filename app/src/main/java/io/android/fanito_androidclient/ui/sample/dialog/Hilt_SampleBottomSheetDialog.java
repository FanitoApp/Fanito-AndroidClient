...
import io.fanito.android.ui.base.BaseBottomSheetDialog;
...
public abstract class Hilt_SampleBottomSheetDialog<T extends ViewDataBinding, V extends BaseViewModel<?>> extends BaseBottomSheetDialog<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SampleBottomSheetDialog_GeneratedInjector) this.generatedComponent()).injectSampleBottomSheetDialog(UnsafeCasts.<SampleBottomSheetDialog>unsafeCast(this));
    }
  }
