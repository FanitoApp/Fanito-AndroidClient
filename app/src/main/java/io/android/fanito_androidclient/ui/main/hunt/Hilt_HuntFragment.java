...
public abstract class Hilt_HuntFragment<T extends ViewDataBinding, V extends BaseViewModel<?>> extends BaseFragment<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HuntFragment_GeneratedInjector) this.generatedComponent()).injectHuntFragment(UnsafeCasts.<HuntFragment>unsafeCast(this));
    }
  }
