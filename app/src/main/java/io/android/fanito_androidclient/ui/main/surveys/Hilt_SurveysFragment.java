...
public abstract class Hilt_SurveysFragment<T extends ViewDataBinding, V extends BaseViewModel<?>> extends BaseFragment<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SurveysFragment_GeneratedInjector) this.generatedComponent()).injectSurveysFragment(UnsafeCasts.<SurveysFragment>unsafeCast(this));
    }
  }
