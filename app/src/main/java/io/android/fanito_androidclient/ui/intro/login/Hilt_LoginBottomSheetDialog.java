...
public abstract class Hilt_LoginBottomSheetDialog<T extends ViewDataBinding, V extends BaseViewModel<?>> extends BaseBottomSheetDialog<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LoginBottomSheetDialog_GeneratedInjector) this.generatedComponent()).injectLoginBottomSheetDialog(UnsafeCasts.<LoginBottomSheetDialog>unsafeCast(this));
    }
  }
