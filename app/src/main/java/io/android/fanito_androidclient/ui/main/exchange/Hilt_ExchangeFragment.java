...
public abstract class Hilt_ExchangeFragment<T extends ViewDataBinding, V extends BaseViewModel<?>> extends BaseFragment<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ExchangeFragment_GeneratedInjector) this.generatedComponent()).injectExchangeFragment(UnsafeCasts.<ExchangeFragment>unsafeCast(this));
    }
  }
