...
public abstract class Hilt_VotingFragment<T extends ViewDataBinding, V extends BaseViewModel<?>> extends BaseFragment<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VotingFragment_GeneratedInjector) this.generatedComponent()).injectVotingFragment(UnsafeCasts.<VotingFragment>unsafeCast(this));
    }
  }
