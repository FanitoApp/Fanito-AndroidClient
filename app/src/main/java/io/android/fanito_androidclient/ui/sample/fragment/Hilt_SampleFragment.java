...
import io.android.fanito_androidclient.ui.base.BaseViewModel;import io.android.fanito_androidclient.ui.sample.fragment.SampleFragment;import io.android.fanito_androidclient.ui.sample.fragment.SampleFragment_GeneratedInjector;
...
public abstract class Hilt_SampleFragment<T extends ViewDataBinding, V extends BaseViewModel<?>> extends BaseFragment<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SampleFragment_GeneratedInjector) this.generatedComponent()).injectSampleFragment(UnsafeCasts.<SampleFragment>unsafeCast(this));
    }
  }
