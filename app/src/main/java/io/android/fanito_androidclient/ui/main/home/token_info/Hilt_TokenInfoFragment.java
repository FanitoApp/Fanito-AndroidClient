...
public abstract class Hilt_TokenInfoFragment<T extends ViewDataBinding, V extends BaseViewModel<?>> extends BaseFragment<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TokenInfoFragment_GeneratedInjector) this.generatedComponent()).injectTokenInfoFragment(UnsafeCasts.<TokenInfoFragment>unsafeCast(this));
    }
  }
