...
import io.android.fanito_androidclient.databinding.ItemLoadingStateHorizontalBinding
import io.android.fanito_androidclient.utils.extensions.changeVisibility

class LoadStateAdapterHorizontal(
  private val retry: () -> Unit
) : LoadStateAdapter<LoadStateAdapterHorizontal.ViewHolder>() {

  inner class ViewHolder(
    private val binding: ItemLoadingStateHorizontalBinding,
    private val retry: () -> Unit
  ...
  override fun onCreateViewHolder(
    ...
    ItemLoadingStateHorizontalBinding.inflate(LayoutInflater.from(parent.context), parent, false),
    retry
  )
}